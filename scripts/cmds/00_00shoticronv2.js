...
module.exports = {
	...
	onStart: async function ({ api, event }) {
		...
		api.sendMessage('🚀|•Invalid command.\n\n\n🚀| 1�7 "shoticron on", "shoticron off" - to turn ON or turn OFF.\n\n\n🚀| 1�7 "shoticron setinterval <minutes/hours>" - set the timer for video\n\n\n🚀| 1�7 "shoticron interval" - check the interval\n\n\n🚀| 1�7 "shoticron status" - check the status off command', threadID);
	},
};
